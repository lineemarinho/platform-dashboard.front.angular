...
var BaseClient = class {
  ...
  executePostToTokenEndpoint(tokenEndpoint, queryString, headers, thumbprint, correlationId, queuedEvent) {
    return __async(this, null, function* () {
      ...
      const response = yield this.sendPostRequest(thumbprint, tokenEndpoint, { body: queryString, headers }, correlationId);
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-YUTVFAUX.js");
    }
  } catch (e) {
  }
  return void 0;
